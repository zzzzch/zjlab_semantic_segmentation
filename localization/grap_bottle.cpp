...
//        string scene_file_path = FLAGS_scene_path + to_string(count) + "_point.pcd";
        string scene_file_path = "/home/zhachanghai/bottle/grap_bottle.pcd";

        pcl::PointCloud<pcl::PointXYZ>::Ptr origin_input(new pcl::PointCloud<pcl::PointXYZ>);
...
//        LOG_EVERY_N(INFO,100) << "distance is " << distance ;
        ...
        LOG(INFO) << "PointCloud representing the planar component: " << cloud_plane->points.size () << " data points.";
        pcl::io::savePCDFileASCII("/home/zhachanghai/bottle/table_plane.pcd", *cloud_plane);
        ...
        pcl::io::savePCDFileASCII("/home/zhachanghai/bottle/up_table_point.pcd", *cloud_filtered_height);
...
//        seg.setModelType(pcl::SACMODEL_PARALLEL_LINE); 		//设置分割模型为圆柱型
...
//
//        pcl::PointCloud<pcl::Normal>::Ptr pipline_normals (new pcl::PointCloud<pcl::Normal>);
//        //存储分割得到的平面上的点到点云文件///
...
//        else
//        {
//            LOG(INFO) << "PointCloud representing the cylindrical component: " << cloud_cylinder->points.size () << " data points." ;
//            pcl::io::savePCDFileASCII("/home/zhachanghai/bottle/table_scene_mug_stereo_textured_cylinder.pcd", *cloud_cylinder);
//        }
        ...
        pcl::io::savePCDFileASCII("/home/zhachanghai/bottle/bottle.pcd", *process_scene);
        ...
        pcl::io::savePCDFileASCII("/home/zhachanghai/bottle/bottle_project.pcd", *cloud_projected);
...
//
        ...
        pcl::io::savePCDFileASCII("/home/zhachanghai/bottle/bottle1.pcd", *cylinder_origin);
